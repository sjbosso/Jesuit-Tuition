...
from branding import (
    ...
    render_footer, USF_GREEN, USF_YELLOW, USF_GRAY,
)
...
render_header("Registrar Review Dashboard", "Commencement Exception Requests")
...
# ── Sidebar metrics ──
with st.sidebar:
    st.markdown(f"### <span style='color:{USF_GREEN}'>Dashboard</span>", unsafe_allow_html=True)
    render_gold_divider()
    m1, m2 = st.columns(2)
